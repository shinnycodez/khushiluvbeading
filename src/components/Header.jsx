...
const Header = () => {
  ...
  return (
    <>
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#F5D2D2] bg-[#F5D2D2] px-4 md:px-10 py-3 relative">
...
#F5D2D2] items-center justify-center pl-4 rounded-l-lg border-r-0">
...
#F5D2D2] focus:border-none h-full placeholder:text-neutral-500 px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal"
                value={searchQuery}
...
#F5D2D2] text-[#141414] hover:bg-[#FFDCDC] transition">🛒 Cart</button>
            {user ? (
              <>
                <button onClick={handleLogout} className="px-4 h-10 rounded-lg bg-[#
#F5D2D2] text-[#141414] text-sm font-semibold hover:bg-[#
#F5D2D2] transition">Logout</button>
...
#F5D2D2] text-white text-sm font-semibold hover:opacity-90 transition"
              >
